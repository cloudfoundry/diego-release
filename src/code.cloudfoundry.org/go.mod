...
require (
	...
	code.cloudfoundry.org/certsplitter v0.0.0-20230803143047-70bd746352a3
	...
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20230802213223-5c087f35e29c
