...
require (
	...
	code.cloudfoundry.org/garden v0.0.0-20240321110920-47c020468789
	...
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20240318154307-a1a918375412
