...
require (
	...
	code.cloudfoundry.org/certsplitter v0.0.0-20230824143334-e323b42f53f5
	...
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20230905040409-4c4166e66c91
